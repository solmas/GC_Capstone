...
namespace GC_Capstone.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public StudentsController(CourseDataContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("StudentID,UserName,FirstName,LastName,PhoneNumber,Address,Password,IsAdmin")] Student student)
        {
